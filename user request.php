        ...
        <img src="photo/p10.png" alt="" width="1000px" height="400px" class="p2"><br><br><br>
            ...
            <table border="1px" class="table">
                <tr>
                    ...
                    <td class="p3"><b><h2>Gender</h2></b></td>
                    <td class="p3"><b><h2>Phone No</h2></b></td>
                    <td class="p3"><b><h2>City</h2></b></td>
                    <td class="p3"><b><h2>Zone</h2></b></td>
                    <td class="p3"><b><h2>Waste</h2></b></td>
                    <td class="p3"><b><h2>Weight</h2></b></td>
                    <td class="p3"><b><h2>User Id</h2></b></td>
                    <td class="p3"><b><h2>Payment Method</h2></b></td>
                    <td class="p3"><b><h2>Amount</h2></b></td>
                        ...
                        while($result=mysqli_fetch_assoc($data)){
                            echo "
								<tr>
                                    ...
                                    <td>". $result["amount"] ."</td>
                                    <td>". $result["status"] ."</td>
									<td><a href='deleterequest.php?de=$result[user_id]'>Delete</a></td>
								</tr>";
                        }
                        echo "</table>";
                    }
